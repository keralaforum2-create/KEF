...
interface RegistrationData {
  ...
  pitchStartupName?: string;
  pitchElevatorPitch?: string;
  pitchProblemStatement?: string;
  pitchProposedSolution?: string;
  pitchProductName?: string;
  pitchProductDescription?: string;
  pitchPricingModel?: string;
  pitchCostPerUnit?: string;
  pitchSellingPrice?: string;
  pitchProfitPerUnit?: string;
  pitchCustomerAcquisitionCost?: string;
  pitchRevenuePerUser?: string;
  pitchTargetCustomers?: string;
  pitchMarketSize?: string;
  pitchCompetitorAnalysis?: string;
  pitchRevenueModel?: string;
  pitchRevenueStreams?: string;
  pitchYear1Revenue?: string;
  pitchYear2Revenue?: string;
  pitchYear3Revenue?: string;
  pitchYear4Revenue?: string;
  pitchYear5Revenue?: string;
  pitchExpectedRoi?: string;
  pitchBreakevenPeriod?: string;
  pitchFeasibilityReasons?: string;
  pitchCurrentStage?: string;
  pitchSupportingFiles?: string;
  pitchDemoVideoLink?: string;
  pitchDeclarationConfirmed?: string;
}
