...
export const registrations = pgTable("registrations", {
  ...
  speakerPortfolio: text("speaker_portfolio"),
...
export const insertRegistrationSchema = createInsertSchema(registrations).omit({
  ...
  speakerPortfolio: z.string().optional(),
  speakerLinkedIn: z.string().url("Please enter a valid LinkedIn URL").optional(),
...
export const startupClinicRegistrations = pgTable("startup_clinic_registrations", {
  ...
  bookedTicket: text("booked_ticket").notNull().default("no"),
